...
Supports: Python, TypeScript, Rust, Go, C/C++, Bash.
...
| Language | Type System | Testing | Linting | Benchmarks |
|---|---|---|---|---|
| **Python** | mypy --strict | pytest --cov | ruff | pytest-benchmark |
| **TypeScript** | tsc --noEmit | vitest --coverage | eslint | vitest bench |
| **Rust** | clippy -D warnings | cargo test | clippy + rustfmt | criterion |
| **Go** | go vet | go test -race | go vet + staticcheck | go test -bench |
| **C/C++** | -Wall -Wextra -Werror | gtest | clang-tidy | google benchmark |
...
- Must have benchmarks for hot paths
- Must have zero TODOs
- Must pass linting
- Must pass security audit
- Must have CI configuration
...
> Rerun and ensure `pytest --cov` shows >=80% coverage before returning."
...
**Q: What languages?**
A: Python, TypeScript, Rust, Go, C/C++, Bash. Edit CODING-CONTEXT.md for others.

**Q: How long does it take?**
A: 20-30 minutes for first project. Faster after.

**Q: What if it fails?**
A: Re-run with clearer TASK-BRIEF or specific fix request.
